		<div class="sidebar" id="sidebar">
		    <h2>功能菜单</h2>
	        <ul>
	            <li {if empty($info['id'])} class="selected"{/if}><a href="{base_url('lab_goods/add')}" >添加货品</a></li>
	            {if $info['id']}<li class="selected"><a href="{base_url('lab_goods/edit/id/')}{$info['id']}">修改货品</a></li>{/if}
