  ...
  {form_open_multipart(site_url($uri_string),'name="form1"')}
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2" class="required"><label for="site_shortname">网站简称:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform">
          	<span class="type-file-show">
          		...
          		<div class="type-file-preview">{if !empty($currentSetting['site_logo']['value'])}<img src="{base_url($currentSetting['site_logo']['value'])}">{/if}</div>
            </span>
