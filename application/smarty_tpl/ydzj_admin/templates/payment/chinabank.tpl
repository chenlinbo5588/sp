  ...
  {form_open(admin_site_url('payment/edit'),'name="form1"')}
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required">网银在线商户号: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
            <input name="chinabank_account" id="chinabank_account" value="{$info['payment_config']['chinabank_account']}" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required">网银在线密钥:</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="chinabank_key" id="chinabank_key" value="{$info['payment_config']['chinabank_key']}" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
                <tr>
