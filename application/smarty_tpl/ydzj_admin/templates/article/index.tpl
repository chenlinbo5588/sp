        ...
        <tr>
          ...
          <td>
        	<select name="ac_id" id="articleClassId">
	          ...
	          <option {if $smarty.post['ac_id'] == $item['ac_id']}selected{/if} value="{$item['ac_id']}">{str_repeat('......',$item['level'])}{$item['level']+1} {$item['name']}</option>
	          {/foreach}
	        </select>
          </td>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        	<ul>
              <li>用于显示在网站页面 底部的相关文字分类对于的文字链接</li>
            </ul>
        </td>
      </tr>
    </tbody>
