{include file="common/main_header.tpl"}
  ...
  {form_open(admin_site_url('authority/user_add'),'id="user_form"')}
    <table class="table tb-type2 nobdb">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="admin_email">登录名:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="admin_email" value="{set_value('admin_email')}" name="admin_email" class="txt"></td>
          <td class="vatop tips">请输入登录名 {form_error('admin_email')}</td>
        </tr>
        <tr>
