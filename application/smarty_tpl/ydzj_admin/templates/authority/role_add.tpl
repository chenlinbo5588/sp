{include file="common/main_header.tpl"}
  ...
  <form id="add_form" method="post">
    ...
    <table class="table tb-type2">
    	<tr class="noborder">
          <td style="width:60px" class="required"><label class="validation" for="admin_name">角色名称:</label></td>
          <td class="vatop rowform"><input type="text" id="gname" maxlength="40" name="gname" class="txt"></td>
        </tr>
        <tr class="space">
          <th colspan="2"> <input id="limitAll" id="limitAll" value="1" type="checkbox">&nbsp;&nbsp;全选</th>
        </tr>
        <tr>
        	<td>设置</td>
        	<td>
        	   <table class="table tb-type2">
	              <tbody>
	                  ...
	                  <td>
						  ...
						  <label for="limit0"><b>站点设置</b>&nbsp;&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="admin/setting/base">站点设置&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="admin/setting/dump">防灌水设置&nbsp;</label>
                  	  </td>
	                </tr>
	                <tr>
	                  <td>
	                  	  <label style="width:100px">&nbsp;</label>
					  	  <input id="limit0" type="checkbox" onclick="selectLimit('limit0')">
						  <label for="limit0"><b>上传设置</b>&nbsp;&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="setting">上传参数&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="upload">默认图片&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="setting.seo">登陆主体图片&nbsp;</label>
                  	  </td>
	                </tr>
	                <tr>
	                  <td>
					  	  ...
					  	  <input id="limit0" type="checkbox" onclick="selectLimit('limit0')">
						  <label for="limit0"><b>上传设置</b>&nbsp;&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="setting">站点设置&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="upload">上传设置&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="setting.seo">SEO设置&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="payment">支付方式&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="message">消息通知&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="express">快递公司&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="offpay_area">配送地区&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="cache">清理缓存&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="perform">性能优化&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="search">搜索设置&nbsp;</label>
	                      <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="admin_log">操作日志&nbsp;</label>
                  	  </td>
	                </tr>
	                <tr>
	                  <td>
    			...
    			<table class="table tb-type2 nomargin">
	              <tbody>
	                  ...
	                  <label style="width:100px">&nbsp;</label>
	                                              ...
	                                              <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="setting">站点设置&nbsp;</label>
	                                              <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="account">账号同步&nbsp;</label>
	                                              <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="upload">上传设置&nbsp;</label>
	                                              <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="setting.seo">SEO设置&nbsp;</label>
	                                              <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="payment">支付方式&nbsp;</label>
	                                              <label><input nctype='limit' class="limit0" type="checkbox" name="permission[]" value="message">消息通知&nbsp;</label>
