  ...
  {form_open(site_url($uri_string),'id="ajaxForm"')}
	...
	<table class="table">
		<tbody>
		    ...
		    <tr class="noborder">
		      <td colspan="2" class="vatop rowform"><input type="text" value="{$info['worker_name']|escape}" name="worker_name" id="worker_name" class="txt"></td>
		    </tr>
		    <tr class="noborder">
		    ...
		    <tr class="noborder">
			  <td colspan="2" class="vatop rowform"><input type="text" value="{$info['worker_mobile']|escape}" name="worker_mobile" id="worker_mobile" class="txt"></td>
			</tr>
