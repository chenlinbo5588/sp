    	...
    	function add_uploadedfile(file_data)
	  	{
	  		...
	  		var newItem = '<tr id="file' + file_data.id + '"><td><input type="hidden" name="file_id[]" value="' + file_data.id + '"/>' + delLink + '</td><td><strong>' + file_data.orig_name + '</strong></td><td>' + file_data.file_size + '<td>' + file_data.username + '</td><td>' + file_data.gmt_create + '</td></tr>';
