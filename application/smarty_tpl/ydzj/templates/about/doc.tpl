     ...
     <div class="" id="smv_MainContent" rel="mainContentWrapper" style="width: 100%; min-height: 300px; position: relative; ">
      <div class="smvWrapper" style="min-width:1120px; height:2020px; position: relative; background-color: rgb(250, 250, 250); background-image: none; background-repeat: no-repeat; background:-moz-linear-gradient(top, none, none);background:-webkit-gradient(linear, left top, left bottom, from(none), to(none));background:-o-linear-gradient(top, none, none);background:-ms-linear-gradient(top, none, none);background:linear-gradient(top, none, none);;background-position:0 0;background-size:auto;" bgscroll="none">
       <div class="smvContainer" id="smv_Main" cpid="461159" style="min-height:400px;width:1120px;height:1300px;  position: relative; ">
        ...
        <div id="smv_con_57_20" ctype="altas" class="esmartMargin smartAbs " cpid="461159" cstyle="Style1" ccolor="Item0" areaid="" iscontainer="False" pvid="" tareaid="" re-direction="all" daxis="All" isdeletable="True" style="height: 1288px; width: 1140px; left: 0px; top: 1170px;z-index:1;">
...
{*             <li class="w-imglist-item">*}
{*              <div class="w-imglist-in">*}
{*               <a target="_self" class="w-imglist-img"> <img class="lazyload CutFill" src="{resource_url('img/tdkcImg/ryzs/2017优秀测绘地理信息工程三等奖.jpeg')}" alt="hedaozhilijinjiang" title="2017优秀测绘地理信息工程三等奖" init="ok" style="width: auto; height: 240px; margin-left: -5px;" /> </a>*}
{*               <div class="w-imglist-title-bg"></div>*}
{*               <a class="w-imglist-title">2017优秀测绘地理信息工程三等奖</a>*}
{*              </div>*}
{*              <div class="w-imglist-bigimg" style="z-index: 78">*}
{*               <a target="_self" class="w-imglist-img"> <img class="lazyload CutFill" src="{resource_url('img/tdkcImg/ryzs/2017优秀测绘地理信息工程三等奖.jpeg')}" alt="hedaozhilijinjiang" title="2017优秀测绘地理信息工程三等奖" init="ok" style="width: auto; height: 336px; margin-left: -7.5px;" /> </a>*}
{*               <div class="w-imglist-title-bg"></div>*}
{*               <a class="w-imglist-title">2017优秀测绘地理信息工程三等奖</a>*}
{*              </div></li>*}
{*             <li class="w-imglist-item">*}
{*              <div class="w-imglist-in">*}
{*               <a target="_self" class="w-imglist-img"> <img class="lazyload CutFill" src="{resource_url('img/tdkcImg/ryzs/2017优秀测绘与地理信息工程铜奖.jpeg')}" alt="tianyuwantongjiang" title="2017优秀测绘与地理信息工程铜奖" init="ok" style="width: auto; height: 240px; margin-left: -5px;" /> </a>*}
{*               <div class="w-imglist-title-bg"></div>*}
{*               <a class="w-imglist-title">2017优秀测绘与地理信息工程铜奖</a>*}
{*              </div>*}
{*              <div class="w-imglist-bigimg" style="z-index: 78">*}
{*               <a target="_self" class="w-imglist-img"> <img class="lazyload CutFill" src="{resource_url('img/tdkcImg/ryzs/2017优秀测绘与地理信息工程铜奖.jpeg')}" alt="tianyuwantongjiang" title="2017优秀测绘与地理信息工程铜奖" init="ok" style="width: auto; height: 336px; margin-left: -7.5px;" /> </a>*}
{*               <div class="w-imglist-title-bg"></div>*}
{*               <a class="w-imglist-title">2017优秀测绘与地理信息工程铜奖</a>*}
{*              </div></li>*}
            <li class="w-imglist-item">
            ...
            <li class="w-imglist-item">
                ...
                <li class="w-imglist-item">
                    <div class="w-imglist-in">
                        ...
                        <div class="w-imglist-title-bg"></div>
                        <a class="w-imglist-title">2014年地理信息工程二等奖</a>
                    </div>
                    <div class="w-imglist-bigimg" style="z-index: 78">
                        <a target="_self" class="w-imglist-img"> <img class="lazyload CutFill" src="{resource_url('img/tdkcImg/ryzs/2014年地理信息工程二等奖.jpg')}" alt="tianyuwantongjiang" title="2014年地理信息工程二等奖" init="ok" style="width: auto; height: 336px; margin-left: -7.5px;" /> </a>
                        <div class="w-imglist-title-bg"></div>
                        <a class="w-imglist-title">2014年地理信息工程二等奖</a>
                    </div></li>
                <li class="w-imglist-item">
                    <div class="w-imglist-in">
                        <a target="_self" class="w-imglist-img"> <img class="lazyload CutFill" src="{resource_url('img/tdkcImg/ryzs/2013年地理信息工程二等奖.jpg')}" alt="tianyuwantongjiang" title="2013年地理信息工程二等奖" init="ok" style="width: auto; height: 240px; margin-left: -5px;" /> </a>
                        <div class="w-imglist-title-bg"></div>
    ...
    $(function () {
        ...
        <div id="smv_con_52_38" ctype="text" class="esmartMargin smartAbs " cpid="461159" cstyle="Style1" ccolor="Item0" areaid="" iscontainer="False" pvid="" tareaid="" re-direction="all" daxis="All" isdeletable="True" style="height: 38px; width: 123px; left: 479px; top: 1050px;z-index:10;">
        ...
        <div id="smv_con_53_48" ctype="text" class="esmartMargin smartAbs " cpid="461159" cstyle="Style1" ccolor="Item3" areaid="" iscontainer="False" pvid="" tareaid="" re-direction="all" daxis="All" isdeletable="True" style="height: 24px; width: 53px; left: 516px; top: 1100px;z-index:5;">
