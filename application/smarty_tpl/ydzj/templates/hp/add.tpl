{include file="common/my_header.tpl"}
    ...
    <div id="pubwrap">
        <div class="w-tixing clearfix"><b>温馨提醒：</b>
            ...
            <p>2. 可通过导入发布求货,系统会按照预定模板扫描您的文件，并发布数据,记录最多100条,超出的部分将不会导入。<a href="{resource_url('example/pub_record.xls')}" target="_blank">下载模版</a> <a class="action" href="{site_url('hp/import')}">导入发布</a></p>
            <p>3. 求货信息默认过期时间<span class="hightlight">90分钟</span>,过期后请用户点击<a class="hightlight" href="{site_url('my_req/recent')}">我的求货</a>菜单进行主动刷新</p>
            <p>4. 同一个货号和尺码的如果已发布且未过期的求货，不可重复发布,即使发布提交也将被忽略。</p>
         </div>
