   ...
   {/if}
   <fieldset>
   	   <legend>{if $info['hid']}{$info['owner_name']|escape}-编辑{else}添加{/if}存量建筑点</legend>
	  	...
	  	<table class="fulltable formtable">
	   		<tbody>
		   		<tr>
		   			...
		   			<td><input type="text" name="id_no" value="{$info['id_no']|escape}" readonly><div class="errtip" id="error_id_no"></div></td>
