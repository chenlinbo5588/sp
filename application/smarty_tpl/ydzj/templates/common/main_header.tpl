...
<div id="main-header">
	<div id="title"><a href="javascript:void(0);">{$profile['basic']['username']|escape}的管理中心</a></div>
    <ul id="topnav" class="top-nav clearfix">
      ...
      <li class="adminid" title="您好:{$admin_profile['basic']['username']|escape}"><span>您好&nbsp;:&nbsp;</span><strong>{$profile['basic']['username']|escape}</strong></li>
      <li><a href="{site_url('index/profile')}"><span>修改密码</span></a></li>
