{include file="common/header.tpl"}
    ...
    *}
    ...
    <script type="text/javascript" src="{resource_url('js/huanxin/strophe.js')}"></script>
	<script type="text/javascript" src="{resource_url('js/huanxin/websdk-1.1.2.js')}"></script>
	<script type="text/javascript">
	var push_appkey = '{$pushConfig['appkey']}';
	</script>
	<script type="text/javascript" src="{resource_url('js/huanxin/webim.config.js')}"></script>
