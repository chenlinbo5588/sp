...
<div id="my" class="bordered">
    ...
    <div class="pd5">
	    ...
	    <div class="row"><span class="icon ico_nickname">昵称:</span><span>{$profile['basic']['nickname']} 在线离线</span><a class="side_link" href="javascript:void(0)">修改</a></div>
	    <div class="row"><span class="icon ico_email">邮箱:</span><span>{$profile['basic']['email']}</span><a class="side_link" href="javascript:void(0)">验证邮箱</a></div>
	    <div class="row"><span class="icon ico_mobile">手机:</span><span>{$profile['basic']['mobile']}</span><a class="side_link" href="javascript:void(0)">绑定手机</a></div>
