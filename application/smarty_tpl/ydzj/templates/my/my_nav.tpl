    <div class="mynav">
        <ul>
            <li class="segment first"><h3><a href="{site_url('my/base')}" title="个人中心">个人中心</a></h3></li>
            ...
            <li {if $uri_string == 'budongchan/cs'}class="current"{/if}><a href="{site_url('budongchan/cs')}">初审</a></li>
            <li {if $uri_string == 'budongchan/fs'}class="current"{/if}><a href="{site_url('budongchan/fs')}">复审</a></li>
        </ul>
    </div>