...
class Tk_Company_Intro {
    ...
    public function response($message){
        ...
        $company_name = $ci->_siteSetting['site_name'];
        
        $qyfr = resource_url("img/cmp/qyfr_zp.jpg");
        $chzz = resource_url("img/cmp/chzz.jpg");
        $url = site_url("company/index");
...
<Description><![CDATA[测绘资质证书]]></Description>
