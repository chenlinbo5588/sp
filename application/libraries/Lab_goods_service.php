...
class Lab_goods_service extends Base_service {
	...
	public function __construct(){
		...
		self::$CI->load->model(array('Lab_Goods_Model', 'Lab_Gcate_Model','Lab_Measure_Model'));
		
		$this->_goodsModel = self::$CI->Lab_Goods_Model;
		$this->_goodsCategoryModel = self::$CI->Lab_Gcate_Model;
		$this->_measureModel = self::$CI->Lab_Measure_Model;
	}
