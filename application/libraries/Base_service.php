...
class Base_service {
	...
	public static $memberExtendModel = null;
	...
	public static function initStaticVars(){
		...
		self::$CI->load->model(array('Member_Model','Adminuser_Model','Setting_Model','Member_Extend_Model','User_Model'));
		...
		self::$memberExtendModel = self::$CI->Member_Extend_Model;
